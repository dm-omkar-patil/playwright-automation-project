...
//   // Wait for jobs to appear with robust selector
//   try {
...
//   console.log(`📄 Found ${jobCards.length} jobs. Starting application loop...`);
...
//       if (easyApply) {
//         const jobTitleEl = await page.$('h2.top-card-layout__title');
//         const companyEl = await page.$('span.topcard__flavor');
...
//         if (submit) {
//           await submit.click();
//           saveAppliedJob(jobTitle, companyName, jobUrl, user);
//           console.log(`✅ Application submitted and saved: ${jobTitle} at ${companyName}`);
//         } else {
...
//       }
//     } catch (err) {
//       console.error('⚠️ Error during application loop:', err.message);
//     }
//   }
